...
//   }
    ...
    svg
      ...
      .append("circle")
        ...
        .on("mousemove", function(d){return (tooltip2.html("Class: "+transform(givenclass)+"<br>Feature: "+givenTopic+"<br>Feature: "+d.path[0]["__data__"].key+"<br> Value: "+Math.floor(d.path[0]["__data__"].value))).style("top", (event.pageY+650)+"px").style("left",(event.pageX-150)+"px");})
