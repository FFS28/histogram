...
//  console.log(data1)
  ...
  svg.append("path")
      ...
      .on("mousemove", function(d){console.log(d);return (tooltip2.html("Scene:1"+"<br>"+"Subfeature: "+subfeatures)).style("top", (event.pageY+600)+"px").style("left",(event.pageX-200)+"px");})
  ...
  svg.append("path")
      ...
      .on("click",function(d){fuc(subfeatures),fuc1(subfeatures);})
      .on("mouseover", function(d){return tooltip2.style("visibility", "visible");})
      .on("mousemove", function(d){console.log(d);return (tooltip2.html("Scene:2"+"<br>"+"Subfeature: "+subfeatures)).style("top", (event.pageY+600)+"px").style("left",(event.pageX-200)+"px");})
      .on("mouseout", function(d){return tooltip2.style("visibility", "hidden");})
      .attr("d",  d3.line()
